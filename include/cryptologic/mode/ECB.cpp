...
std::vector<uint64_t> ECB::encrypt_mode(std::string msg, uint64_t& key, uint64_t& key2)
{
...
std::string ECB::decrypt_mode(std::vector<uint64_t> msg, uint64_t& key, uint64_t& key2)
{
